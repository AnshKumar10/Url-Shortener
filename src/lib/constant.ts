...
export const Faqs = [
  ...
  },
  {
    ...
    answer:
      "Yes. Creating an account allows you to manage your URLs, view detailed analytics, and customize your short URLs. It's free to sign up and gives you access to all our powerful features.",
  },
  {
    value: "item-3",
